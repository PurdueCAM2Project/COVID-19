...
returnval = call('python tools/demo.py configs/elephant/crowdhuman/cascade_hrnet.py ./models_pretrained/epoch_19.pth.stu images/test/ result_our_crowdhuman2_cascade_hr/', shell=True)
